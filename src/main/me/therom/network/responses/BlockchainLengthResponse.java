...
public class BlockchainLengthResponse extends Response<Integer>
{
	public BlockchainLengthResponse(JsonHelper jsonHelper, InputStream stream) throws InvalidMessageException, IOException
	{
	 ...
	 * X + 2 bytes: Number of blocks + line delimiter (\n)
	 *
